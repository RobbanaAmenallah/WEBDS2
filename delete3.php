...
function delete3(PDO $pdo, $titre) { // Changer le nom du paramètre à $titre
    try {
        $stmt = $pdo->prepare("DELETE FROM ajoutblog2 WHERE titre = :titre"); // Utiliser le bon nom de paramètre
